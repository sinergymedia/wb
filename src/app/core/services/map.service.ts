...
export class MapService {
  ...
  getPlaceDetails(placeId: string, fields: string[]) : Observable<Array<google.maps.places.PlaceResult>> {
    return Observable.create((observer) => {
...
getPlacePhotos(placeId: string): Observable<Array<google.maps.places.PlacePhoto>> {
  return Observable.create((observer) => {
    this._PlacesService.getDetails({
      placeId : placeId,
